Pod::Spec.new do |s|
  ...
  s.platform         = :ios, '7.0'
  s.source           = { :git => 'https://github.com/BeeModule/CTAssetsPickerController.git', :tag => 'v2.9.5' }
  s.source_files     = 'CTAssetsPickerController/*.{h,m}'
  s.resource_bundles = { 'CTAssetsPickerController' => ['Resources/CTAssetsPicker/*.png', 'Resources/*.lproj'] }
